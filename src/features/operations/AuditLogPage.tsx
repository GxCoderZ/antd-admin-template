...
const auditDefaultVisibleColumnKeys = [
	"actorUsername",
	"action",
	"target",
	"result",
	...
	return (
		<Flex gap={token.marginLG} vertical>
			<LogTablePanel<PlatformAuditLog>
				...
				defaultVisibleColumnKeys={auditDefaultVisibleColumnKeys}
					...
					selectedLog
						? [
								...
								},
								{
									...
									children: selectedLog.actorId ?? notRecorded,
								},
								{
									key: "action",
								...
								},
								{
									...
									children: selectedLog.targetId ?? notRecorded,
								},
								{
									key: "result",
