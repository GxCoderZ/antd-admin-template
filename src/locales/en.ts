export const enTranslation = {
	...
	adminShell: {
		...
		formExamples: {
			...
			basic: {
				submitError: "Basic form submission failed",
				...
				fields: {
					...
					summary: "Description",
					priority: "Priority",
					notify: "Notify after submission",
				},
				placeholders: {
				...
				validation: {
					title: "Enter an item title of up to 80 characters",
					owner: "Enter an owner of up to 40 characters",
					summary: "Enter a description of up to 500 characters",
				},
			},
			step: {
				steps: {
				...
				placeholders: {
					...
					owner: "Enter an owner",
					scheduledAt: "Select an execution date",
					notes: "Enter additional notes",
				},
				validation: {
					name: "Enter an item name of up to 80 characters",
					owner: "Enter an owner of up to 40 characters",
					notes: "Notes can contain up to 300 characters",
				},
				next: "Next",
				previous: "Back",
				confirmSubmit: "Confirm and submit",
				confirmHint: "Review the information before submitting.",
				noNotes: "None",
				restart: "Start another",
				submitError: "Step form submission failed",
				submitSuccess: "Submission complete",
			},
		},
		deviceInfo: {
			device: "Device",
