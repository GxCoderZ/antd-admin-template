export const zhTWTranslation = {
	...
	adminShell: {
		...
		contentCategories: {
			...
			fields: {
				categoryName: "分類名稱", categoryCode: "分類識別碼", parentCategory: "上級分類", status: "分類狀態",
				title: "內容標題", category: "所屬分類", owner: "負責人", contentStatus: "內容狀態",
			},
			filters: { keyword: "關鍵字", status: "內容狀態" },
			statuses: { active: "啟用", disabled: "停用" },
			itemStatuses: { all: "全部狀態", draft: "草稿", published: "已發佈" },
			columns: { title: "內容標題", category: "所屬分類", status: "狀態", owner: "負責人", updatedAt: "更新時間", actions: "操作" },
			feedback: {
				loadError: "分類內容載入失敗", saveError: "儲存失敗，請稍後再試", deleteError: "刪除失敗，請稍後再試",
		...
		users: {
			...
			roles: {
				...
				empty: "暫無角色",
				highPrivilege: "高權限",
				highPrivilegeRisk: "包含使用者、角色或系統設定等高影響權限，請謹慎指派。",
				loadError: "無法載入使用者角色",
